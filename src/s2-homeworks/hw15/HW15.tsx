...
const HW15 = () => {
    ...
    const onChangePagination = (newPage: number, newCount: number) => {
        ...
        setSearchParams({...Object.fromEntries(searchParams), page: newPage.toString(), count: newCount.toString()})
        //
    }
    ...
    const onChangeSort = (newSort: string) => {
        ...
        setSearchParams({...Object.fromEntries(searchParams), sort: newSort.toString()})
    }
    ...
    return (
        <div id={'hw15'}>
            ...
            <div className={s2.hw}>
                ...
                {idLoading && <div className={s.background}/>}
